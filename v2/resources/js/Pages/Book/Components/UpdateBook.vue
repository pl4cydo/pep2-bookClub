...
console.log(a.book[0])

const form = useForm({
    title: a.book[0].title,
    year: a.book[0].year,
    writter: a.book[0].writter,
    synopsis: a.book[0].synopsis,
    category_id: a.book[0].category_id,
    selfComment: a.book[0].selfComment
});

const submit = () => {
    form.put(route('book.update', a.book[0].id))
    location.reload();
}

const deleteBook = () => {
    if(confirm("Tem certeza?")){
        form.delete(route('book.destroy', a.book[0].id));
    }
}
        ...
        <div class="formPopUp">
            ...
            <div class="formHeader">
                ...
                <div class="headerExit">
                    <Link class="headerExitLink" :href="route('book.bookView', { id: a.book[0].id })">x</Link>
                </div>
            </div>
